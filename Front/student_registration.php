...
<?php
    ...
    if (isset($_REQUEST['username'])) {
        ...
        $query    = "INSERT into `students` (name, username, password)
                     VALUES ('$name', '$username', '" . md5($password) . "')";
        $result   = mysqli_query($con, $query);
        if ($result) {
            echo "<div class='form'>
                  <h3>You are registered successfully.</h3><br/>
                  <p class='link'>Click here to <a href='student_login.php'>Login</a></p>
                  </div>";
        } else {
            echo "<div class='form'>
                  <h3>Required fields are missing.</h3><br/>
                  <p class='link'>Click here to <a href='student_registration.php'>registration</a> again.</p>
                  </div>";
        }
    } else {
?>
                ...
                <div class="row">
                                ...
                                <div class="col-md-8" style="background-color: whitesmoke; padding-top: 100px; padding-bottom: 100px">
                                    <div class="row" style="text-align: center;">
                                        <div class="row">
                                            <h1 style="text-align: center; padding-bottom: 50px;">Student Registration</h1>
                                        </div>
                                        <div class="col-md-2">

                                        </div>
                                        <div class="col-md-8" style="background-color:text-align: center; padding: 50px; text-decoration: none; color: black;">
											...
											<p class="link"><a href="student_login.php">Click to Login</a></p>
											 </form>
                                        </div>
